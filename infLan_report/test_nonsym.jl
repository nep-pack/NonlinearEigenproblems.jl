...
σ=0;
γ=1;
λ,_,err=iar(nep1;σ=σ,γ=γ,Neig=100,displaylevel=1,maxit=100,tol=1e-12,check_error_every=1,errmeasure=rel_err)
...
λ1,_,err=iar(pnep;σ=σ,γ=γ,Neig=100,displaylevel=1,maxit=200,tol=1e-9,check_error_every=1,errmeasure=err_lifted)
