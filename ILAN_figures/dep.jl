...
λ,v=tiar(nep;maxit=300,tol=1e-12,neigs=Inf,logger=1,check_error_every=Inf,errmeasure=rel_err
)
CSV.write("ILAN_figures/dep_eigs.csv", λ)

# COMPUTE REFERENCE EIGENVALUES WITH ILAN (Beyn)
println("RUNNING ILAN (BEYN)")
λ2,v2=ilan(nep,σ=0,γ=1;neigs=100,logger=1,maxit=100,tol=1e-10,check_error_every=Inf,v=v0,
...
λ3,v3=ilan(nep,σ=0,γ=1;neigs=100,logger=1,maxit=100,tol=1e-10,check_error_every=Inf,v=v0,
...
λ4,v4=ilan(nep,σ=0,γ=1;neigs=100,logger=1,maxit=100,tol=1e-10,check_error_every=Inf,v=v0,
