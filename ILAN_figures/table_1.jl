using NonlinearEigenproblems, Random, SparseArrays, Test, LinearAlgebra, PyPlot, CSV, DelimitedFiles, BenchmarkTools
...
λ2,v2,err2,_=ilan(nep,σ=0,γ=1;neigs=100,logger=0,maxit=mm,tol=1e-8,check_error_every=Inf,v=v0,errmeasure=rel_err,
inner_solver_method=NEPSolver.ContourBeynInnerSolver(tol=-Inf,radius=4,N=1000))
@btime λ2,v2,err2,_=ilan(nep,σ=0,γ=1;neigs=100,logger=0,maxit=mm,tol=1e-8,check_error_every=Inf,v=v0,errmeasure=rel_err,
inner_solver_method=NEPSolver.ContourBeynInnerSolver(tol=-Inf,radius=4,N=1000))

λ3,v3,err3,_=ilan(nep,σ=0,γ=1;neigs=100,logger=0,maxit=mm,tol=1e-8,check_error_every=Inf,v=v0,errmeasure=rel_err,
inner_solver_method=NEPSolver.IARInnerSolver(tol=1e2,maxit=50))
@btime λ3,v3,err3,_=ilan(nep,σ=0,γ=1;neigs=100,logger=0,maxit=mm,tol=1e-8,check_error_every=Inf,v=v0,errmeasure=rel_err,
inner_solver_method=NEPSolver.IARInnerSolver(tol=1e2,maxit=50))

λ4,v4,err4,_=ilan(nep,σ=0,γ=1;neigs=100,logger=0,maxit=mm,tol=1e-8,check_error_every=Inf,v=v0,errmeasure=rel_err,
inner_solver_method=NEPSolver.IARInnerSolver(tol=1e2,maxit=100))
@btime λ4,v4,err4,_=ilan(nep,σ=0,γ=1;neigs=100,logger=0,maxit=mm,tol=1e-8,check_error_every=Inf,v=v0,errmeasure=rel_err,
inner_solver_method=NEPSolver.IARInnerSolver(tol=1e2,maxit=100))
