...

{
    ...
    "category": "section",
    "text": "Due to the multiple dispatch and handling of types in Julia, code may run faster if one uses types instead of function handles. It is possible to do the same simulation as above with a user defined type.You first need to define a new typejulia> struct RefErrmeasure <: Errmeasure; nep::NEP; endThe error measure should then provided in the function estimate_error:julia> v0=ones(size(nep,1));\njulia> (λref,v)=resinv(nep,v=v0,λ=230^2+1im,displaylevel=1);\njulia> function NonlinearEigenproblems.estimate_error(e::RefErrmeasure,λ,v)\n         return abs(λ-λref)/abs(λ);\n       end\njulia> (λ,v)=resinv(nep,v=v0,λ=250^2+1im,displaylevel=1,tol=1e-10,errmeasure=RefErrmeasure);\nIteration:  1 errmeasure:1.274091618457501296e-01\n...\nIteration: 49 errmeasure:1.269396691930517923e-10\nIteration: 50 errmeasure:7.608430406801784718e-11"
},
...

{
    ...
    "category": "section",
    "text": "Errmeasureestimate_errorinit_errmeasure"
},
...

{
    ...
    "title": "Deflation",
    "category": "section",
    "text": "Due to structure of the representation of NEPs in NEP-PACK it is possible to do deflation, by transformation of the NEP-object. The deflation is based on theory provided in Effenbergers thesis and the main function consists of deflate_eigpair. See also the tutorial on deflation.deflate_eigpair"
},
