...

{
    ...
    "category": "section",
    "text": "Consider Schrödinger type eigenvalue problem on the interval 0L_1,begineqnarray*\n left(\n fracpartial^2partial x^2\n-V(x)-lambda^2\nright)psi(x)=0 xin0L_1\n   psi(0)=0\n   psi(L_1)=0\nendeqnarray*We wish to compute eigenvalue λ and eigenfunction psi. Moreover, we assume that the potential function V(x) is benign in the domain L_0L_1, e.g., constant. In the simulations we will consider this function  V(x)=\nbegincases\n1+sin(alpha x)   xin0L_0=01\nV_0  xin(L_0L_1)=(18)\nendcaseswhere α is large, i.e., the potential has high oscillations in one part of the domain.<br>\n<img src=\"https://user-images.githubusercontent.com/11163595/49676288-62c71080-fa79-11e8-8542-3b7857720473.png\" height=300>This tutorial illustrates how we can avoid a discretization of the domain L_0L_1 and only discretize 0L_0, by solving a NEP."
},
