...
nep, Σ, Xi, v, nodes, xmin, xmax = particle_init(2)

# solve nlep
@time X, lambda, res, solution_info = nleigs(nep, Σ, Xi=Xi, displaylevel=verbose > 0 ? 1 : 0, maxdgr=50, minit=120, maxit=200, v=v, nodes=nodes, static=true, return_details=verbose > 1)
