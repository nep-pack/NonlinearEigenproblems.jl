...
@testset "compute_types" begin
    ...
    push!(testlist,compute_types_metadata(pep,Float64,true,[],[],[]));
    ...
    push!(testlist,compute_types_metadata(pep_bigfloat,BigFloat,true,[],[],[]));
    ...
    push!(testlist,compute_types_metadata(pep_complex,ComplexF32,false,[],[],[]));
    ...
    push!(testlist,compute_types_metadata(spmf_nep,Float64,true,[],[],[]));
    ...
    push!(testlist,compute_types_metadata(spmf_nep2,BigFloat,true,
                                          bigfloats_and_float16,bigfloats_and_float16,bigfloats_and_float16));
    ...
    for i in 1:size(testlist,1)
        ...
        nep=testlist[i].nep; stype="$(typeof(nep))"
        @testset "Testing compute nep$i: $stype" begin
            nepreal=testlist[i].nep_real;
            n=size(nep,1);
            eltype_nep=testlist[i].nep_numbertype;
            skip_types_Mder=testlist[i].skip_types_Mder;
            skip_types_Mlincomb=testlist[i].skip_types_Mlincomb;
            skip_types_MM=testlist[i].skip_types_MM;
